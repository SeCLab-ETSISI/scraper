...
async def fetch_links_from_page(session, url):
    ...
    links = []
    articles = soup.find_all('article', class_='johannes-post johannes-layout-d johannes-layout-g')
...
async def extract_links(base_url='https://decoded.avast.io/tag/apt/page/'):
    all_links = []
    page_num = 1
...
extract_links.__name__ = "decoded_avast_extractor"
