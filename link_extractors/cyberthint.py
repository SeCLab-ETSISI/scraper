...
async def fetch_links_from_page(session, url):
    ...
    links = []
    a_tags = soup.find_all('a', href=True, rel='bookmark')
    for a_tag in a_tags:
        links.append(a_tag['href'])
    return links

async def extract_links(base_url='https://cyberthint.io/category/threat-intelligence-reports/page/'):
    all_links = []
    page_num = 1
...
extract_links.__name__ = "cyberthint_extractor"
