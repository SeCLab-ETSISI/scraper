...
async def fetch_links_from_page(session, url):
    ...
    links = []
    divs = soup.find_all('div', class_='col-12 col-xl-4')
    for div in divs:
...
async def extract_links(base_url='https://blog.talosintelligence.com/category/threat-advisory/page/'):
    all_links = []
    page_num = 1
...
extract_links.__name__ = "talos_extractor"
